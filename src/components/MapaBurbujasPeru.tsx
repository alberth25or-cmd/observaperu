        ...
        <div className="relative w-full bg-slate-50 rounded-xl overflow-hidden h-[350px] sm:h-[450px] lg:h-[600px]">
          ...
          >
            <Geographies geography={geoUrl}>
              {({ geographies }) =>
                geographies.map((geo) => {
                  ...
                  const matchingDept =
                    Object.entries(DEPARTAMENTOS_MAP).find(
            ...
            {statsPorDepartamento.map((dept) => {
              ...
              return (
                <Marker key={dept.departamento} coordinates={dept.coords}>
                  <g
                  ...
                  >
                    <circle
                      ...
                      fill={
                        isLima ? "#1b2b5a" : isCallao ? "#2E7D8F" : "#4A90E2"
                      }
          ...
          {hoveredDept && (
            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-50 bg-white p-3 sm:p-4 border border-slate-200 rounded-lg shadow-xl max-w-[150px] sm:max-w-none">
              <p className="font-bold text-[#0b1b3b] text-sm sm:text-base mb-1">
                {statsPorDepartamento.find(
                  (d) => d.departamento === hoveredDept,
                )?.departamento || hoveredDept}
              </p>
          ...
          {statsPorDepartamento.map((dept) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-sm font-bold text-[#0b1b3b]">
                  {dept.count}
                </span>
              </div>
            );
