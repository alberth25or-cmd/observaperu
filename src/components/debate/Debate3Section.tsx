    ...
    <section>
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <p className="mt-2 text-sm text-slate-500">
          ...
          <strong>25 de marzo de 2026</strong> &mdash; {data.metadata.candidatos} candidatos,{" "}
      ...
      <p className="text-xs text-slate-400 mt-4 text-center">
        Debate JNE/TV Perú 25/03/2026. Clasificación de tono mediante análisis de palabras clave.
