...
export default function Debate5Section({ data }: Props) {
  ...
  return (
    <section>
      ...
      <div className="mb-6 sm:mb-8">
        <div className="flex items-center gap-3 flex-wrap">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1b2b5a] leading-tight">
            Debate JNE Perú 2026 — Quinta Jornada (31 mar)
          </h2>
        ...
        <p className="mt-2 text-sm text-slate-500">
          ...
          <strong>debate presidencial JNE del 31 de marzo de 2026</strong> &mdash;{" "}
          ...
          Temas: <strong>educación, innovación y empleo</strong>.
        </p>
      </div>

      {/* KPIs */}
      <DebateKPICards data={data} jornada="Quinta jornada" />
      ...
      <div className="bg-[#eef2fb] rounded-xl px-4 py-3 text-sm text-slate-700 mb-4">
        <p>
          En la quinta jornada del debate JNE 2026 (temas: educación, innovación y empleo),{" "}
